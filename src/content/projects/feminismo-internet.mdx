...
author: Ana Carolina
description: Explorando a interseção da internet das coisas aplicada aos corpos e o feminismo de dados, incluindo implicações relacionadas a vieses algorítmicos.
---
